...
export const avatarForm = content.querySelector('.popup_type_avatar');
export const deleteForm = content.querySelector('.popup_type_delete');
...
//define consts
export const imageForm = content.querySelector('.popup_show_image');
export const popupImage = content.querySelector('.popup-preview__picture');
export const popupTitle = content.querySelector('.popup-preview__caption');
